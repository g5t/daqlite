...
$DAQLITE_HOME/bin/daqlite $BROKER -f $DAQLITE_CONFIG/nmx/nmx_p2.json $KAFKA_CONFIG &
$DAQLITE_HOME/bin/daqlite $BROKER -f $DAQLITE_CONFIG/nmx/nmx_p3.json $KAFKA_CONFIG &
